...
<body>
	...
	<div class="form-search">
		<form name="form1" id="formSearch" method="get" action="">
			搜索: 帐号：<input type="text" style="" name="username"
				value="${param.username}" /> <select name="order" id="orderby">
			...
			<tbody>
				...
				<c:forEach items="${list}" var="map">
					<tr>
						...
						<td align="center"><a href="admin_updt.do?id=${map.id}">修改</a>
							<a href="admin_delete.do?id=${map.id}"
