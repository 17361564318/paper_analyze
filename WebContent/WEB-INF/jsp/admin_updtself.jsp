...
<body>
	...
	<form action="adminupdate.do" method="post" name="form1" id="form1">
		编辑管理员: <br>
		<br>
		<table width="100%" class="table table-insert" border="1"
			...
			<tr>
				...
				<td><input style="width: 150px;" data-rule-required="true"
					...
					remote="checkno.do?checktype=update&id=${mmm.id}&table=admin&col=username"
					data-msg-remote="内容重复了" id="username" name="username"
					value="${ssm:Info_html(mmm.username)}" type="text" /> <span
