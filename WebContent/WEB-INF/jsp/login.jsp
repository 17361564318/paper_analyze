		...
		<div class="container">
			<div class="row align-items-center py-5">
				<div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
					<div class="pr-lg-5">
						<img src="htstyle/img/illustration.svg" alt="" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-5 px-lg-4">
					<h2 class="text-base text-primary text-uppercase mb-4">高校试卷分析系统</h2>
					<p class="text-muted">欢迎使用高校试卷分析系统</p>
					<form id="loginForm" action="authAdminLogin.do?a=a" class="mt-4"
						method="post">
						...
						<div class="form-group mb-4">
							<input type="text" name="pagerandom" placeholder="验证码"
								class="form-control border-0 shadow form-control-lg text-violet"
								style="width: 180px; display: inline-block" /> <img alt="刷新验证码"
								title="点击刷新验证码"
