...
<!-- theme stylesheet-->
<link rel="stylesheet" href="htstyle/css/style.default.css"
	id="theme-stylesheet">
...
<body class="body-main">
	...
	<header class="header">
		<nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
			...
			<a href="index.do" class="font-weight-bold text-uppercase text-base">高校试卷分析系统</a>
			<ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
				<li class="nav-item ml-auto"><a href="./" target=""
					class="btn btn-primary">前台首页</a></li>
				<li class="nav-item ml-2"><a href="logout.do"
					class="btn btn-danger" onclick="return confirm('你确定退出？')">安全退出</a>
				</li>
				<li class="nav-item ml-2">
					欢迎登录：${sessionScope.username}，${sessionScope.cx}</li>
	...
	<div class="d-flex align-items-stretch">
		...
		<div class="page-holder w-100 d-flex flex-wrap">
			<div class="container-fluid px-xl-5">
				<section class="py-5">
					<div class="iframe">
						<iframe src="sy.do" name="main" frameborder="0" marginwidth="0"
