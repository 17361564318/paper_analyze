...
<BODY leftMargin=5 topMargin=5 rightMargin=5>
	...
	<table width="100%" height="193" border="1" align="center"
		...
		<TBODY>
			<TR align=middle bgColor=#ffffff>
				<td colspan="2" bgColor=#CADCEA><strong>高校试卷分析系统</strong></td>
			</TR>
			<TR align=middle bgColor=#ffffff>
				<TD width="10%" align="left">系统作者：</TD>
				<TD width="41%" align="left"><font class="t4">冯浩楠</font></TD>
			</TR>
			<TR align=middle bgColor=#ffffff>
				<TD align="left">指导老师：</TD>
				<TD align="left">董瑞洪</TD>
			</TR>
			<TR align=middle bgColor=#ffffff>
				<TD align="left">联系方式：</TD>
				<TD align="left"><font class="t41">17361564318</font></TD>
			</TR>
		</TBODY>
	</TABLE>
	<p>&nbsp;</p>
