					...
					<tr>
						...
						<td align="center"><c:choose>
								<c:when test="${'学生' == sessionScope.cx }">
									<%
										if (Query.make("kaoshijieguo")
															.where("tikuid", Info.makeTableParam(pageContext.getAttribute("map"), "id"))
															.where("kaoshiren", session.getAttribute("username")).count() == 0) {
									%>
									<a href="tiku_detail.do?id=${map.id}">开始考试</a>
									<%
										}
									%>
